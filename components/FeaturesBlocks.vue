      ...
      <div class="py-12 md:py-20 border-t border-gray-800">
        ...
        >
          ...
          >
            ...
            <h4 class="h4 mb-2">Analythics</h4>
          ...
          >
            ...
            <h4 class="h4 mb-2">Components</h4>
            <p class="text-lg text-gray-400 text-center">
              Duis aute irure dolor in reprehenderit in voluptate velit esse
              cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
              cupidatat.
          ...
          >
            ...
            <h4 class="h4 mb-2">Contributions</h4>
            <p class="text-lg text-gray-400 text-center">
              Duis aute irure dolor in reprehenderit in voluptate velit esse
              cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
              cupidatat.
          ...
          >
            ...
            <h4 class="h4 mb-2">Figma Sync</h4>
            <p class="text-lg text-gray-400 text-center">
              Duis aute irure dolor in reprehenderit in voluptate velit esse
              cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
              cupidatat.
          ...
          >
            ...
            <h4 class="h4 mb-2">Airtable Sync</h4>
            <p class="text-lg text-gray-400 text-center">
              Duis aute irure dolor in reprehenderit in voluptate velit esse
              cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
              cupidatat.
          ...
          >
            ...
            <h4 class="h4 mb-2">2 way Sync</h4>
            <p class="text-lg text-gray-400 text-center">
              Duis aute irure dolor in reprehenderit in voluptate velit esse
              cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
              cupidatat.
