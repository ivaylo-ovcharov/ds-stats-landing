      ...
      <div class="pt-32 pb-20 md:pt-40 md:pb-44">
        ...
        >
          ...
          <div
            ...
            data-aos="fade-right"
          >
            <h1 class="h1 font-playfair-display mb-4">Join Early Access</h1>
            <p class="text-xl text-slate-400 mb-8">
              Connect with like-minded peers, and embark on a journey of skill
              elevation. Let's learn and grow together!
            </p>
            <div
            ...
            >
              ...
              <a
                class="btn text-white bg-gray-700 hover:bg-gray-800 w-full sm:w-auto sm:ml-4"
                href="#0"
                >Join Waiting list</a
              >
            </div>
